export const SITE_URL = (import.meta.env.VITE_SITE_URL ?? "https://dfstash.bzr.lt").replace(/\/$/, "")
...
export const GITHUB_REPO_URL = "https://github.com/siyamhosan/DeltaForcePorfitTracker"
...
export const DESKTOP_APP_EXE_URL =
  "https://github.com/siyamhosan/DeltaForcePorfitTracker/releases/download/v0.1.0/Delta.Force.Desktop.Tracker_0.1.0_x64-setup.exe"
